...
namespace ScreenToGif.Model.ExportPresets
{
    public abstract class ExportPreset : BindableBase, IExportPreset
    {
        private Export _type;
        private EncoderType _encoder;
        ...
        private PartialExportType _partialExport = PartialExportType.Selection;
        ...
        private CopyType _copyType = CopyType.File;
        ...
        public PartialExportType PartialExport
        {
            get => _partialExport;
        ...
        public virtual Task<ValidatedEventArgs> IsValid()
        {
            ...
            if (SaveToClipboard && CopyType == CopyType.Link && !UploadFile)
